...
window.onload = function() {
	...
	function sendMessage(e) {
		...
		receiver.postMessage('Hello for attacker', 'http://avicoder.me');
	}
...
<hr />
                  ...
                  <ul class="nav navbar-nav">
					...
					<li><a href="/Labs/2/index.php">Session Puzzling</a></li>
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="/Labs/3/case-5/index.php">DOM XSS</a></li>
                          <li class="divider"></li>
 ...
 <li class="dropdown-header">Login/Registration Page</li>
					  ...
					  <li ><a href="/Labs/9/index.php">CORS Exploitation</a></li>
					  
					
					<li class="dropdown active">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Web Messaging Vulnerability <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                		 <li class="active" ><a href="/Labs/10/index.php">Origin Validation </a></li>

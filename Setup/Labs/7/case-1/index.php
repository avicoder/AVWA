...
<center><h2><span class="label label-info">Demo</span></h2></center>
      ...
      <form class="form-signin" action="" method="post">
        <center><h3 class="form-signin-heading">XML injection &gt;&lt;</h3></center>
        <label for="inputEmail" class="sr-only">Inject Here</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="Inject here"  name="inject_string" required autofocus><br />
...
if(isset($_REQUEST['submit'])){
				$displayxml = str_replace('Inject1', '<span style="color:red"> '.htmlentities($_REQUEST['inject_string']).'</span>', htmlentities($xmldata));

...
<div class="panel  panel-success">
  <div class="panel-heading"><i class="fa fa-terminal"></i>  Test Case <span class="badge pull-right">OTG-CLIENT-012</span></div>
  <div class="panel-body">
...
<center><h2><span class="label label-info">Demo</span></h2></center>
      ...
      <form class="form-signin" action="register.php" method="post">
       <center> <h2 class="form-signin-heading">Register here</h2> </center>
        ...
        <input type="name" id="inputEmail" class="form-control" placeholder="Ram"  name="firstname" required autofocus><br />
        <label for="inputEmail" class="sr-only">Last Name</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="Mohan"  name="lastname" required autofocus><br />
        <label for="inputEmail" class="sr-only">Email</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="rammohan@yahoo.com"  name="email" required autofocus><br />
        <label for="inputEmail" class="sr-only">City</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="Mumbai"  name="city" required autofocus><br />
        <label for="inputEmail" class="sr-only">Credit Card no.</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="4566XXXXXXXXXXXXXX"  name="credit" required autofocus><br />
        <label for="inputEmail" class="sr-only">Phone no.</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="9887654321"  name="phone" required autofocus><br />
			<label for="inputEmail" class="sr-only">Password</label>
        <input type="password" id="inputEmail" class="form-control" placeholder="password"  name="password1" required autofocus><br />
		<label for="inputEmail" class="sr-only">Confirm Password</label>
        <input type="password" id="inputEmail" class="form-control" placeholder="Confirm password"  name="password2" required autofocus><br />
	  ...
	  <div class=pull-right> Already sign up ? click here to <a href="login.php"><span class="label label-primary"> Login</span></a></div><br />

...
<div class="panel  panel-success">
  ...
  <div class="panel-body">
Analyse HTTP responses on accessing folder paths of directories with invalid user and with valid user. (Example:- With invalid user - 403 response with Valid user - 404)
...
<tr class="tableizer-firstrow"><th>S. No.</th><th>Testing Technique</th><th>Where to Apply</th><th>Expected Results</th><th>Interpretation</th></tr>
 <tr><td>1</td><td>At login page, supply an incorrect username and incorrect password</td><td>Login page</td><td>If HTTP response doesn't differs for a valid user and for an invalid user</td><td>Safe</td></tr>
 <tr><td>2</td><td>At login page, supply a correct username and incorrect password</td><td>Login Page</td><td>If HTTP response differs for a valid user and for an invalid user</td><td>Unsafe</td></tr>
</table>

...
<center><h2><span class="label label-info">Demo</span></h2></center>
      ...
      <form class="form-signin" action="" method="post">
        ...
        <input type="name" id="inputEmail" class="form-control" placeholder="Last Name"  name="lastname" required ><br />
        <label for="inputEmail" class="sr-only">Email</label>
        <input type="name" id="inputEmail" class="form-control" placeholder="Email"  name="email" required ><br />

        <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit" >Get in</button>
		<br/>

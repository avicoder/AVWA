...
If  websocket connection is not established over SSL then sensitive information can be stolen and data integrity can be threatened.
...
<div class="panel  panel-success">
  ...
  <div class="panel-body">
Server uses SSL for socket connections?
...
<tr class="tableizer-firstrow"><th>S. No.</th><th>Testing Technique</th><th>Where to Apply</th><th>Expected Results</th><th>Interpretation</th></tr>
 <tr><td>1</td><td>Check the requests or client side code for the presence of wss:// URI which would confirm that websocket is being used over SSL.
</td><td>Anywhere in the application</td><td>Connection established using the ws:// URI and sensitive information is sent in clear text over the websocket connection.</td><td>Unsafe</td></tr>
 <tr><td>2</td><td>""</td><td>""</td><td>Connection established using the wss:// URI and sensitive information is sent over SSL encrypted websocket connection.</td><td>Safe</td></tr>
</table>
